  ...
  return (
    <div className="flex min-h-screen bg-slate-50 relative overflow-hidden">
      ...
      <main className="flex-1 flex flex-col min-w-0 h-screen overflow-y-scroll overflow-x-hidden relative">
        <header className="h-16 shrink-0 bg-white shadow-xs flex items-center justify-between px-4 lg:px-8 sticky top-0 z-10 border-b border-slate-200">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2.5 p-1 px-3 rounded-full hover:bg-slate-100 transition-all">
        ...
        {isMobileMenuOpen && (
          <>
            <motion.div 
              ...
              className="fixed inset-0 bg-indigo-950/60 z-[80] lg:hidden"
            />
            <motion.aside 
              initial={{ x: '-100%' }} 
              animate={{ x: 0 }} 
